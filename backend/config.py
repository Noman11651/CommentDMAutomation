...
# Page token (never expires) for graph.facebook.com messaging endpoint.
# Falls back to INSTAGRAM_ACCESS_TOKEN if not set.
INSTAGRAM_PAGE_TOKEN = os.getenv("INSTAGRAM_PAGE_TOKEN", "").strip() or INSTAGRAM_ACCESS_TOKEN
